...
/**
 * Ping HUD element. Live values are supplied by the Fabric layer through
 * {@link GameState}; this declaration owns the id, category and settings.
 */
public final class PingModule extends HudModule {

    public PingModule() {
        super("ping", "Ping", "Ping overlay");    }

    @Override
    protected List<String> lines(GameState game) {
        return game.pingMillis() < 0 ? List.of("Ping: --") : List.of("Ping: " + game.pingMillis() + "ms");
    }
}
